# Generated by Django 5.1.6 on 2025-04-06 19:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('initiator_skill', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='offered_exchanges', to='core.userskill')),
                ('recipient_skill', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='requested_exchanges', to='core.userskill')),
            ],
        ),
        migrations.CreateModel(
            name='Feedback',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('exchange', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='feedbacks', to='core.exchange')),
